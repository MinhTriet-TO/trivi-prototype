          ...
          <div className="sidebar-inner px-1 pt-3">
            ...
            <Nav className="flex-column pt-3 pt-md-0">
              ...
              <CollapsableNavItem
                ...
                icon={faUser}
              >
                <NavItem title="Information Customer" link={Routes.Customer.path} />
                <NavItem title="CustomerProfile" link={Routes.CustomerProfile.path} />

              </CollapsableNavItem>

                <NavItem title="Session" link={Routes.Session.path} icon = {faNetworkWired}/>
                <NavItem title="Product" link={Routes.Product.path} icon = {faPager} />
                <NavItem title="Transaction" link={Routes.Transaction.path} icon={faBalanceScale} />
                <NavItem title="TransactionItem" link={Routes.TransactionItem.path} icon = {faBoxOpen}/>
              </CollapsableNavItem>
              {/* <NavItem
