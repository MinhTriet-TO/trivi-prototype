...
import ReactLogo from "../assets/img/technologies/v-UQTR.png";
import { domainPath } from "../constants/utils";
import BgImage from "../assets/img/illustrations/photoTR.jpg";
...
export default class Signin extends Component {
    ...
    fetch(domainPath + "token-auth/", {
      ...
      .then((json) => {
        if (json.token) {
          ...
          alert("Your account information is incorrect. Please try again");
        }
      })
      .catch((err) => alert(err));
  };
  ...
  render() {
    ...
    return (
      <main className="bg-success vh-100">
              ...
              >
                <div className="bg-white shadow-soft border rounded border-primary p-4 p-lg-5 w-100 fmxw-500">
                  <div className="text-center text-md-center mb-4 mt-md-0">
                    <h3 className="mb-0">Trivi Login</h3>
                  </div>
                  <div className="text-center text-md-center mb-4 mt-md-0">
                    <Image className="" src={ReactLogo} height={120} />
                  </div>
                  <Form
                    className="mt-4"
